...
public class SampleController {
	...
	/*
	 * 引数のBindingResultで、バリデーションの結果を受け取るサンプル
	 */
	@PostMapping("/apisample/v3")
	@ResponseBody
	public SampleResponse restApiSample3(@RequestBody @Validated SampleBody request, BindingResult result){
		if (result.hasErrors()) {
